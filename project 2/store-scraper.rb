...
Explore
 @A-Grabish Sign out
0
0 0 fab/benandjerrys_scraper
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights
benandjerrys_scraper/store_scraper.rb
de7c2c7  on Sep 16, 2013
@fab fab Remove unrefactored version of scraper and rename file
     
100 lines (85 sloc)  2.71 KB
require 'mechanize'
require 'csv'
